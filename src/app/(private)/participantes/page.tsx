      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
        ...
        {/* <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Meninas</p>
              <p className="text-2xl font-bold text-gray-900">
                {students.filter((s) => s.sexo === 'feminino').length}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Meninos</p>
              <p className="text-2xl font-bold text-gray-900">
                {students.filter((s) => s.sexo === 'masculino').length}
              </p>
            </div>
          </div>
        </div> */}
